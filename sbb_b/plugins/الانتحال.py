...
async def _(event):
    ...
    await edit_delete(event, "**- تم بنجاح انتحال حساب المستخدم السورس @kepthon**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            f"#الانتحال\nتم انتحال المستخدم: [{first_name}](tg://user?id={user_id }) السورس @kepthon ",
        )
...
async def revert(event):
    ...
    await edit_delete(event, "**- تم بنجاح ارجاع الحساب الى وضعه الاصلي السورس @kepthon**")
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID,
            "#الاعادة\nتم بنجاح اعادة الحساب الى وضعه السابق السورس @kepthon",
        )