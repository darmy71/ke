...
def jmthonalive_text():
    ...
    jmthon_caption += f"**{EMOJI} اصدار كيبثون :** `{jmthonversion}`\n"
...
ROZ_T = (
    f"**⌯︙بوت كيبثونيعمل بنجاح 🤍،**\n"
    f"**   - اصدار التليثون :** `1.23.0\n`"
    f"**   - اصدار كيبثون:** `4.0.0`\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/kepthon"),
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/ua9u9"),
                ]
            ]
