...
async def join_channel():
    try:
        await kepthon(JoinChannelRequest("@kepthon"))
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.الاوامر"))
async def _(event):
...
☆ DATE : `{m9zpi}`
☆ ID : `{event.sender_id}`
☆ SOURCE kepthon : @kepthon**

-قـم بأرسال `.الاوامر`
''')


@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.م1"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec1)


@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.م2"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec2)


@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.م3"))
async def _(event):
    start = datetime.datetime.now()
    await event.edit(sec3)


@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.م4"))
async def _(event):
    start = datetime.datetime.now()
...
@kepthon.on(events.NewMessage(outgoing=False, pattern='/start'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('مرحبا ايها المطور')

@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.اعادة تشغيل"))
async def update(event):
    await event.edit("• جارِ اعادة تشغيل السورس ..\n• انتضر 1-2 دقيقة  .")
    await sython.disconnect()
    await sython.send_message("me", "`اكتملت اعادة تشغيل السورس !`")

@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع المليار"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | ᴋᴇᴘᴛʜᴏɴ')
        channel_entity = await sython.get_entity(bot_username)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython.send_message(event.chat_id, f"لايوجد قنوات  في البوت | kep")
                break
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=r"\.تجميع الجوكر"))
async def _(event):
        await event.edit("حسنا, تأكد من انك مشترك ب قنوات الاشتراك الاجباري لتجنب الأخطأء")
        channel_entity = await sython.get_entity(bot_usernamee)
        await sython.send_message('@A_MAN9300BOT', 'جاري التجميع بواسطة | ᴋᴇᴘᴛʜᴏɴ')
        channel_entity = await sython.get_entity(bot_usernamee)
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".احسب (.*)"))
async def _(event):
    try:
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".للكروبات(?: |$)(.*)"))
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".للخاص(?: |$)(.*)"))
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".تكرار (.*)"))
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".مؤقت (.*)"))
async def spammer(event):
...
async def _(event):
      await event.reply("""السـورس يعمـل | ᴋᴇᴘᴛʜᴏɴ
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
قناة السورس : https://t.me/kepthon
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@sython.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""kep OWNER : @Ua9U9"""
)

@kepthon.on(events.NewMessage(outgoing=True, pattern=".حلويات"))
async def _(event):
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".قلوب"))
async def _(event):
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".العد التنازلي"))
async def _(event):
    animation_interval = 0.3
    animation_ttl = range(54)
    event = await event.edit("🔟")
...
@kepthon.on(events.NewMessage(outgoing=True, pattern=".قمر"))
async def _(event):
...
@kepthon.on(admin_cmd(pattern="طائره(?: |$)(.*)"))
async def _(event):
    "أمر الرسوم المتحركة"
